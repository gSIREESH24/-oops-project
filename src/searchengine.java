...
public class searchengine extends JFrame {
    ...
    public searchengine(int userId,String username) {
            ...
            while (rs.next()) {
                ...
                addToCartButton.addActionListener(e -> {
                   try {
                        ...
                        insertProductToUserCart(dbName,userId, productName, price, description, imagePath);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new searchengine(1,"Sireesh"));
    }
}
